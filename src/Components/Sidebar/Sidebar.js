...
export default function Sidebar() {
  ...
  let shortsLogo = (
    ...
    >
      <path
        d="M7 28a.999.999 0 0 1-1-1V5a1 1 0 0 1 1.521-.854l18 11a1.001 1.001 0 0 1 0 1.708l-18 11A1 1 0 0 1 7 28zM8 6.783v18.434L23.082 16 8 6.783z"
        fill="#ffffff"
      />
    </svg>
  );
  let subscriptionsLogo = <svg></svg>;
  let libraryLogo = <svg></svg>;
  return (
    <div className="sidebar">
      <Button text="Home" logo={homeLogo} />
      <Button text="Shorts" logo={homeLogo} />
      <Button text="Subscriptions" logo={homeLogo} />
      <Button text="Library" logo={homeLogo} />
    </div>
  );
}
